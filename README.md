...
<p class='util--hide'>View <a href='https://learn.co/lessons/sinatra-basic-sessions-lab'>Sinatra Sessions Lab</a> on Learn.co and start learning to code for free.</p>
